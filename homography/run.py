...
cv_desk = img_as_float(io.imread('homography/cv_desk.jpg'))
cv_desk_gray = rgb2gray(cv_desk)
cv_cover = img_as_float(io.imread('homography/cv_cover.jpg'))
hp_cover = img_as_float(io.imread('homography/hp_cover.jpg'))
